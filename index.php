...
# Operators 
// | مسؤلين عن الزيادة والنقصان |
# Incrementing  |الزيادة ++ | 
# Deincrementing  |النقصان --  |
...
/*
Post increment
دا بكل بساطه ان اولا الـزياده او النقصان  بتبقي بعد المتغير 
واول قيمه بتبقي زي ماهي ومن ثم بتبدء انها تنضاف هتتفهم وهتوضح اكتر في المثال 
----------------
pre increment
هنا الزيادة او النقصان  بتبقي قبل المتغير ومن اول قيمة بتبدء انها تنضاف هتوضح برضوا اكتر في المثال 
---------------
*/
...
$x = 5;
echo $x++;  // |out =>5| عشان تفهم البوست بكل بساطه هنا كانك طبعت المتغير وبعدين ضيفتله قيمة بس كده وحتي ال++  بعد المتغير اطبع ثم ضيف 
echo "<br>"; 
echo $x; // outpout ==> 6
echo "<br>"; 
echo $x--; // out => 6 
...
$s = 5;
echo ++$s;  // |out=> 6|هنا الاضافه تمت قبل المتغير يعني انت ضفت القيمه للمتغير وبعدين هتطبعه عكس فوق انت فوق يعتبر طبعت المتغير وبعدين ضفتله قيمه 
echo "<br>"; 
echo $s; // outpout ==> 6
echo "<br>"; 
echo --$s; // out => 5
...
/*
And &&   , or ||   , Not !  , xor
شرح بسيط عشان لو حد لسه جديد  بص ياعزيزي 
اولا الــ 
And  
هقولك قصه صغنتوته هتفهم منها 
انا مدي فلوس لشخص ما 
وقولتله محمد واحمد هيجوا ياخدوا منك الفلوس ولازم يكونوا هما الاتنين مع بعض 
لو محد جه لوحده ماتدهوش حاجه ولو احمد جه لوحده برضوا ماتدهوش حاجه انما لو جهم مع بعض اديهم الفلوس 
And هنا بمعني وا 
محمد وا احمد 
------
ثانيا ال 
...
بالعربي بمعني لو 
يعني 
لو محمد بس اللي جه اديلوا الفلوس 
ولو احمد بس اللي جه اديلوا الفلوس 
المهم واحد من الاتنين 
طب ولو الاتنين جهم ايوه اديهم الفلوس برضوا ياعم 
---
ثالثا ال
Not ! 
ودي من اسمها نفي 
...
---
رابع xor 
اعمل عليها سيرش عشان تفهم فكرتها اكتر 
لاني الصراحه ماقبلتهاش في اللغات اللي معايا
*/

echo "<br>";


var_dump(10 > 1 And 10 > 15  ); //out => false 
echo "<br>";
var_dump(10 > 1 or 10 > 15  ); //out => true
echo "<br>";


var_dump(10 != 20 ); // out => true
echo "<br>";
